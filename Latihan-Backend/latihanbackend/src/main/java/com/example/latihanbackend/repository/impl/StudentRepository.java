...
public class StudentRepository implements IStudentRepository {
	...
	public Student updateStudent(int id, Student student) {
		...
		JdbcTemplate.update(query, new Object[] {student.getDeskripsi_diri(), student.getEmail(), student.getHard_skill(), student.getInterest(), student.getJenis_kelamin(), student.getNama(), student.getSoft_skill(), student.getUmur(), id});
		return student;
	}
